...
var xiudian_url='<?php echo ($sys["xiudian_url"]); ?>';


//var web_muban='<?php echo ($sys["web_muban"]); ?>';
var web_muban_status = '<?php echo ($sys["web_muban_status"]); ?>';
...
<!-- <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=8D1kIOGsmbbeG9k4U3klKl77"></script> -->
    ...
    <!-- compiled CSS --> 
  <link rel="stylesheet" href="/Public/css/eqShow-common-3.6.2.css"/>
    ...
    <link rel="stylesheet" href="/Public/css/eqShow-3.6.2.css"/>
    ...
    <script src="/Public/eq/3.6/eqShow-3.6.2.js?v=11"></script>
