			...
			<ul class="menu list-unstyled" id="navigation_current_page">
				...
				<li class="hasSubmenu"> <a href="#sidebar-fusion-realestate" data-toggle="collapse"><i class="fa fa-home"></i><span>模板管理</span></a>
					<ul id="sidebar-fusion-realestate" class="collapse">
                       ...
                       <li><a href="#" onClick="mainFrame.location.href='/adminc.php?c=collect'" ><i class="fa "></i>采集官方模板</a></li>
					   <li><a href="#" onClick="mainFrame.location.href='/adminc.php?c=collect_70c'" ><i class="fa "></i>采集70c模板</a></li>
				...
				<li class="hasSubmenu"> <a href="#sidebar-fusion-cate" data-toggle="collapse"><i class="fa fa-home"></i><span>类别管理</span></a>
					<ul id="sidebar-fusion-cate" class="collapse">
					
					  <li><a href="#" onClick="mainFrame.location.href='/adminc.php?c=cate&filetype=scene_type'" ><i class="fa "></i>场景分类</a></li>
