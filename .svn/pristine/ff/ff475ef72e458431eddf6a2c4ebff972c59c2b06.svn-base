        ...
        <div style="text-align: left; padding: 20px; text-align: left;">
            ...
            <table style="vertical-align: top;">
				...
				<tr>
                    ...
                    <td> 
                        <input type="radio" value="1" name="user[web_muban_status]" <?php if($user[web_muban_status]==1): ?>   checked='checked'  <?php endif; ?> > 模板1    <input type="radio" value="2" name="user[web_muban_status]" <?php if($user[web_muban_status]==2): ?>   checked='checked'  <?php endif; ?> >      模板2  
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <span class="frm_input_box">
                            <input name="user[xiudian_url]" type="text"   class="frm_input"   value="<?php echo ($user["xiudian_url"]); ?>" /></span>
