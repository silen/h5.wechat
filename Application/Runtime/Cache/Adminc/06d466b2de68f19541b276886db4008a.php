...
<body>
   ...
   <div class="col_main">
        <div class="main_hd">
            ...
            <p class="extra_info">
				<a class="button2" href='?c=user&a=add' style='margin-bottom: 2px;'>添加</a>
...
var url = location.href.lastIndexOf("&act") == -1 ? location.href.substring((location.href.lastIndexOf("/")) + 1) : location.href.substring((location.href.lastIndexOf("/")) + 1, location.href.lastIndexOf("&act"));
           ...
           用户名:
            <input name="scenename_varchar" type="text"  class="search" style="width: 100px;" value="<?php echo ($filename_varchar); ?>"/>
