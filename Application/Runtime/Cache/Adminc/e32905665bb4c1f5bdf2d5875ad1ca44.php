...
<br><br>
            ...
            <br><br>
             <font color="red"> 采集教程：<a href="/Public/70c.htm" target="blank">点我进入</a></font>
        </div>
        <div>
        <ul id="cjzt">
...
<script type="text/javascript">
    ...
    $("#collect").click(function(){
        ...
        if(url != '') {
        $('#collect').val('正在拼命下载中...');
        $.get("adminc.php?c=collect_70c&a=collect",{cs:url,dtagid:dtagid,tagid:tagid}, function(data){
        if(data.url != null){ 
...
//  var url = $("#text").val();
  ...
  $("#tagid").empty();
   $.get("adminc.php?c=collect_70c&a=Type",{biztype:biztype}, function(data){
if(data != null){
   $("#tagid ").append(data);
    }else{$('#tagid').after();
        }
