            ...
            <div class="title_tab" id="topTab">
                <ul class="tab_navs mt title_tab">
                    <li class="tab_nav js_top  selected" data-id="mphelper"><a href="javascript:void(0);">
                      <?php echo (getCateName($type)); ?>小类 </a></li>
                </ul>
            </div>
            <p class="extra_info">
               <a class="button2" href='?c=tag&a=add&type=<?php echo ($type); ?>&biztype=<?php echo ($biztype); ?>' style='margin-bottom: 2px; '>添加</a>
            </p>
        </div>
                        ...
                        <tr>
                            ...
                            <th scope="col" width="15%">
                              ...
                              <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr onMouseOver="this.className='RecordRowOver'" onMouseOut="this.className=''">
                                    ...
                                    <td align="center" style="width:60px;"> <a href="?c=tag&a=e&id=<?php echo ($item["tagid_int"]); ?>"><img src="/assets/admin/images/edit.png" /> </a>
                                    <a href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["scenename_varchar"]); ?>]吗？')) window.location='?c=tag&a=del&id=<?php echo ($item["tagid_int"]); ?>&type=<?php echo ($type); ?>&biztype_int=<?php echo ($item["biztype_int"]); ?>'"><img src="/assets/admin/images/delet.png" /> </a>
                                      
                                    
                                    </td>
                                    <td>
                                        <?php echo ($item["name_varchar"]); ?> 
                                    </td>
                                    <td>
                                         <?php echo (getBiztypeCateNameN("$type",$item["biztype_int"])); ?>
                                    </td>
                                    <td>  <?php echo ($item["sort"]); ?></td>
                                    <td>
                                    <?php if($item['create_time'] > 0): echo ($item["create_time"]); endif; ?>
